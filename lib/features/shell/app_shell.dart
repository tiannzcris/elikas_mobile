...
class _AppShellState extends ConsumerState<AppShell> {
  ...
  Widget build(BuildContext context) {
    ...
    // A persistent global FAB was tried here for one-tap Staff Dashboard
    // access from any tab, but it ended up overlapping content on
    // several screens (worse when switching tabs/pages) -- Settings'
    // "Staff Dashboard" entry is a clean two-tap path with none of that
    // risk, so that's the only entry point now.
    return Scaffold(
